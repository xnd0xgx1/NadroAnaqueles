...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const requestOptions = {
        ...
        headers: myHeaders,
        body: JSON.stringify({
          codigoDeEmpleado: username,
          codigoDeAcceso: password,
        }),
      };
  ...
  return (
    ...
    >
      <Image
        source={{
          uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/logo-CWdMm6EnIe8XQIsSy9lNFaYcrSgbNh.png",
        }}
        style={styles.logo}
        resizeMode="contain"
      />
      <View>
        <Text style={styles.subtitle}>
          Aplicativo para la optimización y análisis de mostradores
        </Text>
      </View>
      ...
      <Image
        source={{
          uri: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/elementosmedicos-Me8T2xie25F7fcMXS6vsk8Jb7MAVgE.png",
        }}
